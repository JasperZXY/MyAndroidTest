...
//                    try {
                        for (int i=1; i<5; i++) {
                            final int a = i;
//                            appendLog("发送请求：" + Thread.currentThread().getName() + " " + a);
//                            appendLog(myAidlRemoteService.multiThread(a));
...
//                        appendLog("error:" + re.getLocalizedMessage());
//                    }
                }
            }
            }
